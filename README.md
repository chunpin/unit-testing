...
This is an in-browser JavaScript library that the Founder of watchandcode.com has been using for years. It's so small and simple that it never occured to him to open source it until he saw all the overly complicated alternatives that are out there.
